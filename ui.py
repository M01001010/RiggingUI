...
class TestTool(QtWidgets.QDialog):
    ...
    def run(self):
        ...
        sel_root = QtWidgets.QPushButton("Root")
        sel_tip = QtWidgets.QPushButton("Tips")
        sel_tree = QtWidgets.QPushButton("Hierarchy")
        sel_all = QtWidgets.QPushButton("Joints")

        selectGrid = QtWidgets.QGridLayout()
        selectGrid.addWidget(sel_root, 0, 0)
        selectGrid.addWidget(sel_tree, 0, 1)
        selectGrid.addWidget(sel_tip, 1, 0)
        selectGrid.addWidget(sel_all, 1, 1)
    ...
    def setLayouts(self):
        ...
        #self.hSecondary.addWidget(self.sN)
        self.hSecondary.addWidget(self.dummy) # added
        ...
        ################# add to main
        #self.mainLayout.addLayout(self.layV0)
        self.mainLayout.addSpacerItem(QtWidgets.QSpacerItem(10, 5, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding))
        self.mainLayout.addLayout(self.layV1)
        self.mainLayout.addSpacerItem(QtWidgets.QSpacerItem(10, 5, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding))
        self.mainLayout.addLayout(self.layV2)
        self.mainLayout.addSpacerItem(QtWidgets.QSpacerItem(10, 5, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding))
    ...
    def setStyle(self):
        ...
        self.l1.setStyleSheet("color: white;background-color: black;")
        self.l1.setFixedHeight(20)

        self.l2.setStyleSheet("color: white;background-color: black;")
        self.l2.setFixedHeight(20)

        self.btnEdit.setStyleSheet("color: black;background-color: gray;")
